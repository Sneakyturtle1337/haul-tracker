import { j as jsxRuntimeExports, c as cn, r as reactExports, o, v as vt, S as Skeleton, u as useNavigate } from "./index-qM1U5xgo.js";
import { H as Hash, B as Button, M as MapPin, A as AlertDialog, a as AlertDialogTrigger, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./map-pin-XCVej9hI.js";
import { B as Badge } from "./badge-B7Sm8wJt.js";
import { c as createSlot, a as createLucideIcon, u as useActiveTrip, b as useCompleteTrip, T as Truck, f as formatEarnings, d as formatMiles, e as useCreateTrip, g as useUpdateTrip, R as RATE_PER_MILE, h as calcEstimatedEarnings } from "./types-C-Oyse92.js";
...
function FieldGroup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[11px] uppercase tracking-widest text-muted-foreground", children: label }),
    children
  ] });
}
function DetailRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] uppercase tracking-widest text-muted-foreground font-body", children: label }),
...
function LiveEarningsPreview({ miles }) {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-muted-foreground mb-0.5", children: "Estimated Earnings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-3xl font-bold font-display leading-none ${ready ? "text-primary" : "text-muted-foreground"}`,
              children: ready ? formatEarnings(earnings) : "—"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-muted-foreground mb-0.5", children: "Rate" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-mono text-muted-foreground", children: [
            "$",
            RATE_PER_MILE.toFixed(3),
            " / mi"
          ] })
        ] })
      ]
...
function NewTripForm() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      ue.success("Trip started!");
    } catch {
      ue.error("Failed to start trip.");
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Date", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Load ID", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Pickup Number", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Pickup Trailer Number", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Pick Up Time", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Drop Time", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Pick Up Location", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Drop Location", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(FieldGroup, { label: "Miles", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(LiveEarningsPreview, { miles: form.totalMiles }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            type: "submit",
            ...
            children: createTrip.isPending ? "Starting…" : "Start Trip"
          }
        )
      ]
    }
...
function EditTripForm({
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      ue.success("Trip updated.");
      onCancel();
    } catch {
      ue.error("Failed to update trip.");
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: updateTrip.isPending ? "Saving…" : "Save Changes"
            }
          )
        ] })
      ]
...
function ActiveTripView({ trip }) {
  ...
  async function handleComplete() {
    try {
      ...
      ue.success("Trip completed!");
      navigate({ to: "/history" });
    } catch {
      ue.error("Failed to complete trip.");
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "active_trip.view", className: "flex flex-col gap-4", children: [
    ...
    !editing && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-muted-foreground mb-0.5", children: "Earnings" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-bold font-display leading-none text-primary", children: formatEarnings(trip.earnings) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-muted-foreground mb-0.5", children: "Miles" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-bold font-display text-foreground", children: formatMiles(trip.totalMiles) })
          ] })
        ]
      }
    ),
    editing ? /* @__PURE__ */ jsxRuntimeExports.jsx(EditTripForm, { trip, onCancel: () => setEditing(false) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Date", value: trip.date }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Load ID", value: trip.loadId })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Pickup Number", value: trip.pickupNumber }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          DetailRow,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Pick Up Time", value: trip.pickupTime }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Drop Time", value: trip.dropTime })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded border border-border bg-card px-3 py-2.5 flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3.5 w-3.5 text-muted-foreground mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-muted-foreground", children: "Pick Up Location" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: trip.pickupLocation })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded border border-border bg-card px-3 py-2.5 flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3.5 w-3.5 text-primary mt-0.5 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-widest text-muted-foreground", children: "Drop Location" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: trip.dropoffLocation })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "active_trip.complete_dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Complete this trip?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "This will mark the trip as completed and move it to your history. You won't be able to edit it afterward." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { "data-ocid": "active_trip.complete_cancel_button", children: "Cancel" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              AlertDialogAction,
              {
...
function EmptyState({ onStart }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-full bg-card border border-border p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { className: "h-8 w-8 text-muted-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base font-display font-semibold text-foreground", children: "No active trip" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Start a new trip to begin tracking your earnings." })
        ] }),
...
function ActiveTripPage() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "active_trip.loading_state", className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-48" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 w-full" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: [0, 1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full" }, i)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-full" })
    ] });
  }
  if (activeTrip) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "active_trip.page", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActiveTripView, { trip: activeTrip }) });
  }
  if (showForm) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "active_trip.page", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Hash, { className: "h-4 w-4 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-display font-semibold uppercase tracking-widest text-foreground", children: "New Trip" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "ghost",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(NewTripForm, {})
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "active_trip.page", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { onStart: () => setShowForm(true) }) });
}
export {
  ActiveTripPage
};
